...
class FlagConfigFetcher {
    constructor(apiKey, httpClient, serverUrl = config_1.LocalEvaluationDefaults.serverUrl, logLevel = loglevel_1.LogLevel.Error, loggerProvider = new logger_1.ConsoleLogger()) {
        this.apiKey = apiKey;
