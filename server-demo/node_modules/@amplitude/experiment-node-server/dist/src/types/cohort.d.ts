export interface CohortStorage {
    ...
    getCohortsForGroup(groupType: string, groupName: string, cohortIds: Set<string>): Set<string>;
    put(cohort: Cohort): void;
    delete(cohortIds: string): void;
}
export declare const USER_GROUP_TYPE = "User";
...
export type Cohort = CohortDescription & {
